        ...
        children: [
          Column(
            children: [
              const Padding(
                padding:
                    EdgeInsets.only(top: 25, left: 15, right: 15, bottom: 5),
                child: Align(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          ...
                          // elevation: 10,
                          value:
                              controller.ketIzin[controller.noKetIzin.hashCode],
                          isDense: true,
                          isExpanded: true,
                          onChanged: (String? value) {
                            controller.noKetIzin =
                                controller.ketIzin.indexOf(value ?? "").obs;
                          },
